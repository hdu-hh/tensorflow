...
var file_tensorflow_core_protobuf_conv_autotuning_proto_rawDesc = []byte{
	...
	0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x57, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68,
...
var file_tensorflow_core_protobuf_conv_autotuning_proto_goTypes = []interface{}{
	...
	(ActivationMode)(0),                // 4: dnn.ActivationMode
}
var file_tensorflow_core_protobuf_conv_autotuning_proto_depIdxs = []int32{
	1, // 0: tensorflow.ConvolutionProto.kind:type_name -> dnn.ConvolutionKind
	2, // 1: tensorflow.ConvolutionProto.input:type_name -> dnn.TensorDescriptorProto
	2, // 2: tensorflow.ConvolutionProto.filter:type_name -> dnn.TensorDescriptorProto
	2, // 3: tensorflow.ConvolutionProto.output:type_name -> dnn.TensorDescriptorProto
	3, // 4: tensorflow.ConvolutionProto.conv_desc:type_name -> dnn.ConvolutionDescriptorProto
	4, // 5: tensorflow.ConvolutionProto.activation:type_name -> dnn.ActivationMode
