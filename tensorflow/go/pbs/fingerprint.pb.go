...
type FingerprintDef struct {
	...
	Version *VersionDef `protobuf:"bytes,6,opt,name=version,proto3" json:"version,omitempty"` // TODO(b/290068219): add USM version when GA
}
...
var file_tensorflow_core_protobuf_fingerprint_proto_goTypes = []interface{}{
	...
	(*VersionDef)(nil), // 1: tensorflow.VersionDef
}
